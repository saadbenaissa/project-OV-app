...
public class ApplicationOpen extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        // Laad 'login.fxml' voor de registratiepagina
        FXMLLoader loginLoader = new FXMLLoader(ApplicationOpen.class.getResource("login.fxml"));
        loginScene = new Scene(loginLoader.load(), 1920, 1080);
